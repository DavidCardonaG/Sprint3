...
def register():
    try:
        ...
        if request.method == "POST":    
            ...
            content = 'Hola, Bienvenido a App Message DKJ!, estas a un paso de registrarte, para activar tu cuenta, haga clic en este enlace ' + flask.url_for('auth.activate', _external=True) + '?auth=' + number
